package Task02TIME1202.TimeTemplate;
...
public class timeStructure {
    ...
    public static class TimeGetters extends TimeSetters{
        ...
        public void addTime_two(TimeGetters obj1, TimeGetters obj2){
        ...
        public void addTIme_multiObjects(TimeGetters... objects){
            int i=0;
            int totalHour=0;int totalMinute=0;int totalSec=0;
            for(TimeGetters obj : objects){
                if(i==0){continue;}

                totalHour=this.getHour()+obj.getHour();
                totalMinute=this.getMinute()+obj.getMinute();
                totalSec=this.getSecond()+obj.getSecond();

                totalMinute+=totalSec/60;
                totalSec%=60;
